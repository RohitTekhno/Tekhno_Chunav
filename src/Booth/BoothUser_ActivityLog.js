...
const BoothUser_ActivityLog = () => {
    ...
    const fetchData = async () => {
        try {
            const statesResponse = await axios.get(`http://192.168.200.23:8000/api/edited_voters/62/`);
                            ...
                            renderItem={({ item, index }) => (
                                <Pressable style={styles.voterItem}>
                                    ...
                                    <View>
                                        ...
                                        <Text style={{ fontSize: 11 }}>Updated Date: {' 2024-09-03'}</Text>
                                    </View>
                                </Pressable>
                            )}
                        />
