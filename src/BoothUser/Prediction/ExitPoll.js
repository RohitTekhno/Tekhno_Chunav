...
export default function ExitPoll() {
    ...
    const getFevourVotedPercentage = async () => {
        try {
            ...
            const result = await axios.get(`http://192.168.1.8:8000/api/get_voter_info_by_booth_user/user_booth_user_id/${buserId}/voter_favour_id/1/voter_vote_confirmation_id/1/`);
            ...
            const result2 = await axios.get(`http://192.168.1.8:8000/api/get_voter_info_by_booth_user/user_booth_user_id/${buserId}/voter_favour_id/1/voter_vote_confirmation_id/2/`);
