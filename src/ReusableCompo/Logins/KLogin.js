...
export default function KLogin() {
    ...
    const [username, setUsername] = useState(""); // Default example data
    const [password, setPassword] = useState(""); // Default example data
    ...
    const LogInUser = async () => {
        if (validate()) {
            ...
            try {
                const response = await axios.post('http://192.168.1.8:8000/api/voter_group_login/', {
