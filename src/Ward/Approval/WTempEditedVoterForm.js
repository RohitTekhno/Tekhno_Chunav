...
const WTempEditedVoterForm = ({ isVisible, onClose, selectedVoter, onEditVoter }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const apiUrl = `http://192.168.1.31:8000/api/update_voter_data_prabhag_user/${selectedVoter.temp_voter_data_voter_id}/`;
...
export default WTempEditedVoterForm;
